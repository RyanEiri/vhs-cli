...
#
# Chunked, resumable VHS upscaling for animation/anime content using Real-ESRGAN.
# Uses the realesrgan-x4plus-anime model by default, which is trained on drawn/cel
# content and produces cleaner results than the general-purpose model for cartoons,
# anime, and other hand-drawn material.
#
...
#                      none:   no lutyuv remap, no brightness uplift
...
echo ">>> VHS animation upscale (chunked, resumable)"
echo "Input file      : $IN"
